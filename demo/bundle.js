...
/***/ function(module, exports, __webpack_require__) {
	...
	var _reactMarked = __webpack_require__(169);

	var _reactMarked2 = _interopRequireDefault(_reactMarked);
	  ...
	  _createClass(App, [{
	    ...
	    value: function render() {
	      return _react2.default.createElement(
	        ...
	        _react2.default.createElement(_reactMarked2.default, { editorClass: 'col-md-6', previewClass: 'col-md-6' })
	      );
	    }
	  }]);
...
/***/ function(module, exports, __webpack_require__) {
	...
	var _marked = __webpack_require__(170);
	...
	var MarkDown = function (_Component) {
	  ...
	  function MarkDown(props) {
	    ...
	    var _this = _possibleConstructorReturn(this, Object.getPrototypeOf(MarkDown).call(this, props));

	    _this.handleChange = function (e) {
	      _this.setState({ html: (0, _marked2.default)(_this.editor.value) });
	    };

	    _this.state = {
	      mode: 'split', html: (0, _marked2.default)(_this.props.source || '')
	    };
	    return _this;
	  }
	  ...
	  _createClass(MarkDown, [{
	    ...
	    value: function componentDidMount() {
	      // cache dom node
	      this.editor = (0, _reactDom.findDOMNode)(this.refs.editor);
	    ...
	    value: function render() {
	      ...
	      var editorClass = _props.editorClass;
	      var previewClass = _props.previewClass;

	      var others = _objectWithoutProperties(_props, ['panelClass', 'editorClass', 'previewClass']);
	      ...
	      return _react2.default.createElement(
	        ...
	        _react2.default.createElement(
	          ...
	          _react2.default.createElement('textarea', { ref: 'editor', name: 'content', onChange: this.handleChange })
	        ),
	        _react2.default.createElement('div', { className: previewClass, dangerouslySetInnerHTML: { __html: this.state.html } })
	      );
	    }
	  }]);
